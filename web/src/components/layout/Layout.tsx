...
import { MessageSquare, Bike, BarChart3, LogOut } from 'lucide-react';
...
const DashboardLayout = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-bg-light dark:bg-gray-950 overflow-hidden text-auteco-blue dark:text-gray-200 transition-colors duration-300">
      ...
      {/* Header bar (global) */}
      <div className="flex items-center justify-end px-6 py-3 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 shrink-0">
        <div className="flex items-center gap-4 text-sm font-medium">
          <span className="hidden sm:inline">Hola, {user?.name || 'Mecánico'}</span>
      ...
      <div className="flex lg:hidden flex-1 flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto">
          ...
          {activeTab === 'metrics' && isAdmin && <AdminPage />}
        </div>

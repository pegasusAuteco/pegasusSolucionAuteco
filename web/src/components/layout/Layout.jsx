...
const Layout = () => {
  ...
  const [activePanelDesktop, setActivePanelDesktop] = useState('queue');
    ...
    <div className="flex flex-col h-screen bg-bg-light dark:bg-gray-950 overflow-hidden text-auteco-blue dark:text-gray-200 transition-colors duration-300">
      ...
      <div className="hidden lg:flex flex-1 overflow-hidden">
        <div className="w-[40%] relative border-r border-gray-100 dark:border-gray-800 shadow-xl dark:shadow-2xl z-10 bg-white dark:bg-gray-900/40 dark:backdrop-blur-sm flex flex-col overflow-hidden">
          {chatHistoryOpen && (
            <>
              <div className="absolute inset-0 bg-black/20 z-10" onClick={() => setChatHistoryOpen(false)} />
      ...
      <div className="flex lg:hidden flex-1 flex-col overflow-hidden">
        {chatHistoryOpen && (
          <>
            <div className="fixed inset-0 bg-black/40 z-30" onClick={() => setChatHistoryOpen(false)} />
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {mobileTab === 'inventory' && (
            <div className="h-full overflow-y-auto"><MotorcycleList /></div>
          )}
          {mobileTab === 'queue' && (
            <div className="h-full overflow-y-auto"><CompactMechanicQueue /></div>
          )}
        </div>

...
const registerSchema = z
  .object({
    ...
    rol: z.enum(['mecanico', 'secretario'], {
...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    nombre: '', email: '', password: '', confirmPassword: '', rol: '', empresa_taller: '',
  })
      ...
      <div className="animate-fade-in-up max-w-md w-full bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden">
        ...
        <form onSubmit={onSubmit} className="p-8 space-y-5">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">Rol en el taller</label>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input name="nombre" value={formData.nombre} onChange={handleChange} type="text" className={inputClass('nombre')} placeholder="Juan Pérez" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input name="email" value={formData.email} onChange={handleChange} type="email" className={inputClass('email')} placeholder="juan@ejemplo.com" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input name="password" value={formData.password} onChange={handleChange} type="password" className={inputClass('password')} placeholder="••••••••" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><Lock className="h-5 w-5 text-gray-400" /></div>
                <input name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} type="password" className={inputClass('confirmPassword')} placeholder="••••••••" />
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Empresa / Taller <span className="text-gray-400 font-normal">(opcional)</span>
              </label>
              <div className="relative">
                ...
                <input name="empresa_taller" value={formData.empresa_taller} onChange={handleChange} type="text" className={inputClass('empresa_taller')} placeholder="Pegasus Auteco" />
              </div>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ¿Ya tienes cuenta?{' '}
            <button type="button" onClick={() => navigate('/login')} className="text-auteco-red hover:text-red-700 font-semibold transition-colors">
              Inicia sesión
            </button>
          </p>
        </form>
